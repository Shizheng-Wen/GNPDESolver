...
from .cmpt.gno import IntegralTransform
from .cmpt.mlp import ChannelMLP
from .cmpt.fno import FNOBlocks
from .cmpt.spectral_convolution import SpectralConv

from .cmpt.utils.fno_utils import SinusoidalEmbedding2D
...
class GINOConfig:
    ...
    fno_in_channels: int = 64
    fno_n_modes: tuple = (16, 16)
...
class GINO(nn.Module):
    ...
    def forward(self,
        ...
        """forward pass of GINO --> latent embedding w/FNO --> GNO out
        ...
        input_geom = graph.physical_to_regional.src_ndata['pos'].to(pndata.device) # (n_in, gno_coord_dim)
        ...
        output_queries = graph.regional_to_physical.dst_ndata['pos'].to(pndata.device)
    ...
    def forward_original(self,  x, input_geom, latent_queries, output_queries, ada_in=None, **kwargs):
